...
export const navData = [
  ...
  { name: 'Who I Am', path: '/about', icon: <HiUser /> },
  { name: 'What I Do', path: '/services', icon: <HiRectangleGroup /> },
  { name: 'How I Work', path: '/work', icon: <HiViewColumns /> },
    {
    name: 'Reach Me',
    path: '/contact',
    icon: <HiEnvelope />,
          ...
          return (
            ...
            >
              ...
              <div className='absolute pr-14 right-0 hidden xl:group-hover:flex'>
                <div className='bg-white relative inline-flex text-primary items-center p-[6px] rounded-[3px]'>
